...
public class GuardarCriatures {
    ...
    // add(Object o, int i) afegeix en la posició i-èssima
    ...
    // les llistes permeten de canviar el contingut d'una posició llarInfants.set(8, new Criatura("ELISA", 3, Code_COLECs.Criatura.NENA)); llarInfants.set(2, llarInfants.get(7));
